...
PROG = "./main.py -ascii" if 'py' in sys.argv else "./main"
...
for t in failed:
  print("Press <enter> to restart test '"+color(t, RED)+"' with output")
  input()
  run("{} {}/{}.test 2>&1 | less".format(PROG, TSTDIR, t), shell=True)
